...
import { sr25519Agreement } from "./agreement.js";
...
export function sr25519Encrypt(message, receiverPublicKey, senderKeyPair) {
...
export function buildSR25519EncryptionKey(publicKey, secretKey, encryptedMessagePairPublicKey, salt = randomAsU8a(keyDerivationSaltSize)) {
...
export function macData(nonce, encryptedMessage, encryptedMessagePairPublicKey, macKey) {
