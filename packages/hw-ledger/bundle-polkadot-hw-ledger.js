const polkadotHwLedger = (function (exports, util) {
  ...
  getDefaultExportFromCjs(toConsumableArray.exports);
  ...
  getDefaultExportFromCjs(asyncToGenerator.exports);
  ...
  function _getVersion() {
    _getVersion = (0, _asyncToGenerator2$1.default)( _regenerator$1.default.mark(function _callee(transport, cla) {
  ...
  function newAcalaApp(transport) {
    return new SubstrateApp(transport, _config.CLA.ACA, _config.SLIP0044.ACA);
  }
  function newElixxirApp(transport) {
    return new SubstrateApp(transport, _config.CLA.XX, _config.SLIP0044.XX);
  }
  ...
  var _app = _classPrivateFieldKey("app");
  var _chain = _classPrivateFieldKey("chain");
  var _transport = _classPrivateFieldKey("transport");
  var _getApp = _classPrivateFieldKey("getApp");
  var _withApp = _classPrivateFieldKey("withApp");
  var _wrapError = _classPrivateFieldKey("wrapError");
  class Ledger {
